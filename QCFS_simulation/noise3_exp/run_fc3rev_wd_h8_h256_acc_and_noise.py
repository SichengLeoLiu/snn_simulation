...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="FC3rev(2h->h) h8~h256: multi-seed clean T0/T16 (L4/L16) + Gaussian noise sweep"
    )
...
def main() -> None:
    ...
    clean_raw_csv = out_dir / "fc3rev_h8_h256_wd_t0_t16_l4_l16_raw.csv"
    clean_mean_csv = out_dir / "fc3rev_h8_h256_wd_t0_t16_l4_l16_mean_std.csv"
    clean_merged_csv = out_dir / "fc3rev_h8_h256_wd_t0_t16_l4_l16_merged.csv"
    ...
    for r in clean_rows:
        clean_bucket[(r["arch"], int(r["hidden_size"]), int(r["L"]), int(r["T"]))].append(float(r["acc"]))
